...
import DoctorRevenueModal from "./DoctorRevenueModal";
...
class ManageDoctor extends Component {
  ...
  // Hàm mở modal doanh thu
  handleOpenRevenueModal = (doctorId, doctorName) => {
    this.setState({
  ...
  render() {
    ...
    return (
      <div>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    ...
                    <button
                      ...
                      onClick={() => this.handleOpenRevenueModal(doctor.id, doctor.lastName + " " + doctor.firstName)}
                      title="Xem doanh thu"
                    >
        ...
        {/* Modal hiển thị doanh thu của bác sĩ */}
        <DoctorRevenueModal
          isOpen={isRevenueModalOpen}
          onClose={this.handleCloseRevenueModal}
